! function (t, i) {
    ...
    return function (t) {
        ...
        function r(t, i, e) {
            for (var o = void 0, n = t.childNodes, s = document.createRange(), r = 0; o = n[r], r < n.length; r++)
                if (3 === o.nodeType) {
            ...
            p = function () {
                function t() {
                    ...
                    this.viewport = {
                        ...
                        width: n(this.props.content),
                        height: s(this.props.content)
                    }, this.position = {
                        x: 0,
                        y: 0
                    }, this.velocity = {
                ...
                return l(t, [{
                    ...
                    value: function () {
                        if (this.bounce && !this.isDragging) {
                            var t = this.position.x < this.boundX.from,
                                i = this.position.x > this.boundX.to,
                                e = this.position.y < this.boundY.from,
                                o = this.position.y > this.boundY.to,
                                n = {
                                    x: 0,
                                    y: 0
                                };
                            if (t || i) {
                                var s = t ? this.boundX.from : this.boundX.to,
                                    r = s - this.position.x,
                            ...
                            if (e || o) {
                                var l = e ? this.boundY.from : this.boundY.to,
                                    p = l - this.position.y,
                    ...
                    value: function () {
                        ...
                        this.events.wheel = function (i) {
                            ...
                            var o = t.props.viewport.scrollLeft,
